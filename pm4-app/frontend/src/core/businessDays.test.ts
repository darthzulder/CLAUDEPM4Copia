...
// Réplica en cliente del script PM4 COL_UTIL_Dias_Habiles (id 95): son DOS
// implementaciones de la misma regla de SLA y nada garantiza que coincidan, así que estos
// tests fijan el contrato del lado cliente. Los feriados entran por argumento, así que todo
// esto es puro — no hace falta tocar useHolidaySet() ni la colección 48.
