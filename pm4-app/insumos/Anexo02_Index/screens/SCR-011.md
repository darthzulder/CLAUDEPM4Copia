...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLD-190 | S1 Detalle del Error Técnico — Prórroga | Código HTTP prórroga | qd_codigoHTTPProrroga | Texto | Label/Solo lectura | No | No | Sí | — | API | — | — | — |
| FLD-191 | S1 Detalle del Error Técnico — Prórroga | Tipo de Error | qd_tipoErrorProrroga | Texto | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-192 | S1 Detalle del Error Técnico — Prórroga | Mensaje técnico de la API | qd_mensajeTecnicoProrroga | Texto | Área de texto | No | No | Sí | — | API | — | — | — |
| FLD-193 | S1 Detalle del Error Técnico — Prórroga | Payload de prórroga enviado | qd_payloadProrroga | Texto | Área de texto | No | No | Sí | — | Sistema | — | — | JSON del payload enviado. |
| FLD-194 | S1 Detalle del Error Técnico — Prórroga | Número de intento prórroga | qd_intentoProrroga | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-195 | S2 Registro de Corrección — Prórroga | Causa Raíz | qd_causaRaizProrroga | Texto | Área de texto | Sí | Sí | No | — | Analista Técnico | — | Campo no vacío | — |
| FLD-196 | S2 Registro de Corrección — Prórroga | Corrección Aplicada | qd_correccionProrroga | Texto | Área de texto | Sí | Sí | No | — | Analista Técnico | — | Campo no vacío | — |
