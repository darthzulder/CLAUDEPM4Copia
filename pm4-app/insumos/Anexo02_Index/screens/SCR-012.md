...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLD-200 | S1 Panel de Error — Prórroga | Código de Error SFC Prórroga | qd_codigoErrorProrroga | Texto | Label/Solo lectura | No | No | Sí | — | API | — | — | — |
| FLD-201 | S1 Panel de Error — Prórroga | Campo Afectado | qd_campoAfectadoProrroga | Texto | Label/Solo lectura | No | No | Sí | — | API | — | — | — |
| FLD-202 | S1 Panel de Error — Prórroga | Mensaje de Error SFC | qd_mensajeErrorProrroga | Texto | Label/Solo lectura | No | No | Sí | — | API | — | — | — |
| FLD-203 | S1 Panel de Error — Prórroga | Intento N.° actual | qd_intentoActualProrroga | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-204 | S2 Campos de Prórroga a Corregir | Motivo de Prórroga | qd_motivoProrroga | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-MOTIVO-PRORR | Valor en catálogo SFC | Motivo aceptado por SmartSupervision. |
| FLD-205 | S2 Campos de Prórroga a Corregir | Nueva Fecha Límite | qd_nuevaFechaLimite | Fecha | Calendario | Sí | Sí | No | — | Usuario | — | Fecha > fecha actual | Nueva fecha de respuesta solicitada. |
| FLD-206 | S2 Campos de Prórroga a Corregir | Contador de Prórroga | qd_contadorProrroga | Número | Número | Sí | Sí | No | — | Sistema/Usuario | — | Validar contra catálogo SFC | N.° de prórroga (1, 2...). |
| FLD-207 | S2 Campos de Prórroga a Corregir | Justificación | qd_justificacionProrroga | Texto | Área de texto | Sí | Sí | No | — | Usuario | — | Campo no vacío | Justificación de la necesidad de prórroga. |
