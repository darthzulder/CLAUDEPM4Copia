...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLD-050 | S1 Detalle del Error Técnico | Código HTTP | qd_codigoHTTP | Texto | Label/Solo lectura | No | No | Sí | — | API | — | — | Ej: 401, 500, 503, Timeout. |
| FLD-051 | S1 Detalle del Error Técnico | Tipo de Error | qd_tipoError | Texto | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | Autenticación / Timeout / Estructura payload / Servidor. |
| FLD-052 | S1 Detalle del Error Técnico | Mensaje técnico de la API | qd_mensajeTecnicoAPI | Texto | Área de texto | No | No | Sí | — | API | — | — | Stack trace o mensaje técnico completo. |
| FLD-053 | S1 Detalle del Error Técnico | Endpoint invocado | qd_endpointInvocado | Texto | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | URL del endpoint de la API intermediaria. |
| FLD-054 | S1 Detalle del Error Técnico | Payload enviado (JSON) | qd_payloadEnviado | Texto | Área de texto | No | No | Sí | — | Sistema | — | — | JSON del payload del intento fallido. |
| FLD-055 | S1 Detalle del Error Técnico | Número de intento acumulado | qd_numeroIntento | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-056 | S2 Registro de Corrección Técnica | Causa Raíz Identificada | qd_causaRaiz | Texto | Área de texto | Sí | Sí | No | — | Analista Técnico | — | Campo no vacío | Descripción técnica de la causa del error. |
| FLD-057 | S2 Registro de Corrección Técnica | Corrección Aplicada | qd_correccionAplicada | Texto | Área de texto | Sí | Sí | No | — | Analista Técnico | — | Campo no vacío | Acciones técnicas tomadas. |
| FLD-058 | S2 Registro de Corrección Técnica | ¿Requiere ajuste en payload? | qd_requiereAjustePayload | Booleano | Radio Sí/No | Sí | Sí | No | — | Analista Técnico | — | — | — |
