...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLD-120 | S1 Contexto del Caso | ID Caso / Código SFC | qd_codigoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-121 | S1 Contexto del Caso | SLA: Días hábiles restantes | qd_slaRestante | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-122 | S1 Contexto del Caso | Versión bajo revisión | qd_versionRevision | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-123 | S1 Contexto del Caso | Área Responsable | qd_areaResponsable | Texto | Label/Solo lectura | No | No | Sí | — | Caso | — | — | — |
| FLD-124 | S1 Contexto del Caso | Fecha de elaboración del borrador | qd_fechaElaboracion | Fecha/Hora | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-127 | S2 Respuesta del Área (solo lectura) | Respuesta al Cliente | qd_respuestaCliente | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-05.1) | — | — | — |
| FLD-128 | S2 Respuesta del Área (solo lectura) | Acciones Tomadas | qd_accionesTomadas | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-05.1) | — | — | — |
| FLD-129 | S2 Respuesta del Área (solo lectura) | ¿Reconocimiento al cliente? | qd_reconocimiento | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-05.1) | — | — | — |
| FLD-130 | S2 Respuesta del Área (solo lectura) | Soportes internos adjuntos | qd_adjuntosSoporte | Archivo | Lista de adjuntos | No | No | Sí | — | Área (PAN-05.1) | — | — | Solo visualización. |
| FLD-131 | S3 Decisión del Analista SAC | Observaciones SAC | qd_observacionesSAC | Texto | Área de texto | Cond. | Sí | No | — | Analista SAC | — | Obligatorio si devuelve | Obligatorio al devolver. Opcional al aprobar. |
...
| ACT-008-03 | Reasignar Caso | Terciaria | Siempre | Abre PAN-05.1 para reasignación. |
