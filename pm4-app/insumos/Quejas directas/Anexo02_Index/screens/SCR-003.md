...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FLD-040 | S1 Panel de Error SmartSupervision | Código de Error SFC | qd_codigoErrorSFC | Texto | Label/Solo lectura | No | No | Sí | — | API SmartSupervision | — | — | Código HTTP y código funcional devuelto por SmartSupervision. |
| FLD-041 | S1 Panel de Error SmartSupervision | Campo Afectado | qd_campoAfectado | Texto | Label/Solo lectura | No | No | Sí | — | API SmartSupervision | — | — | Nombre exacto del campo rechazado. |
| FLD-042 | S1 Panel de Error SmartSupervision | Valor Rechazado | qd_valorRechazado | Texto | Label/Solo lectura | No | No | Sí | — | API SmartSupervision | — | — | El valor que fue enviado y rechazado. |
| FLD-043 | S1 Panel de Error SmartSupervision | Mensaje de Error SFC | qd_mensajeErrorSFC | Texto | Label/Solo lectura | No | No | Sí | — | API SmartSupervision | — | — | Mensaje literal devuelto por SmartSupervision. |
| FLD-044 | S1 Panel de Error SmartSupervision | Intento N.° actual (M1/M2) | qd_numeroIntentoM1M2 | Número | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | — |
| FLD-045 | S1 Panel de Error SmartSupervision | Fecha/Hora del rechazo | qd_fechaRechazo | Fecha/Hora | Label/Solo lectura | No | No | Sí | — | Sistema | — | — | Timestamp registrado en log. |
| FLD-046 | S2 Campo a Corregir | Campo específico en corrección | qd_campoCorreccion | Dinámico | Texto o Lista | Sí | Sí | No | — | Sistema → Usuario | — | Según campo | Solo el campo afectado. No el formulario completo. |
| FLD-047 | S2 Campo a Corregir | Justificación de la corrección | qd_justificacionCorreccion | Texto | Área de texto | No | Sí | No | — | Usuario | — | — | Comentario opcional del gestor. |
| FLD-048 | S3 Historial de Intentos | Historial de intentos anteriores | qd_historialIntentos | Lista de registros | Tabla/Grid | No | No | Sí | — | Sistema | — | — | Columnas: Intento \| Fecha \| Campo afectado \| Código error. Solo lectura. |
