<!-- converted from Anexo02_Mockups_TOBE_QuejaDirectas_v3_1.xlsx -->
...
|  | FLD-001 | SCR-001 | S1 Encabezado del Caso | 1 | Número de Caso (ID BPM) | qd_idCasoBPM | Texto | Label/Solo lectura | No | No | Sí | [Auto] | Sistema BPM |  | — | Asignado por el BPM al crear el registro. |
|  | FLD-002 | SCR-001 | S1 Encabezado del Caso | 2 | Canal de Recepción | qd_canal | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-CANAL | Canal habilitado en catálogo activo | Solo se captura una vez. No se vuelve a pedir en pantallas posteriores. |
|  | FLD-003 | SCR-001 | S1 Encabezado del Caso | 3 | Fecha y Hora de Creación | qd_fechaCreacion | Fecha/Hora | Label/Solo lectura | No | No | Sí | [Auto] | Sistema BPM |  | — | Timestamp automático del sistema. |
|  | FLD-004 | SCR-001 | S2 Datos del Consumidor Financiero | 1 | Nombre o Razón Social | qd_nombres + qd_apellidos / qd_razonSocial | Texto | Texto | Sí | Sí | No | — | Usuario |  | Máx 200 car. Sin caracteres no permitidos SFC |  |
|  | FLD-005 | SCR-001 | S2 Datos del Consumidor Financiero | 2 | Tipo de Identificación | qd_tipoIdentificacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-TIPO-ID | Valor en catálogo SFC activo | CC, CE, NIT, Pasaporte, TI... |
|  | FLD-006 | SCR-001 | S2 Datos del Consumidor Financiero | 3 | Número de Identificación | qd_numeroIdentificacion | Texto | Texto | Sí | Sí | No | — | Usuario |  | Solo dígitos. Mín 6, máx 15 caracteres |  |
|  | FLD-007 | SCR-001 | S2 Datos del Consumidor Financiero | 4 | Correo Electrónico | qd_correoElectronico | Correo | Correo | Sí | Sí | No | — | Usuario |  | Formato RFC 5321 obligatorio | Destino del correo de respuesta final. Obligatorio (bloquea si vacío o inválido). |
|  | FLD-008 | SCR-001 | S2 Datos del Consumidor Financiero | 5 | Tipo de Persona | qd_tipoPersona | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-TIPO-PERSONA | Valor en catálogo | Natural / Jurídica |
|  | FLD-009 | SCR-001 | S2 Datos del Consumidor Financiero | 6 | Código País | qd_codigoPais | Catálogo | Lista desplegable | Sí | Sí | No | 170 — Colombia | Catálogo SFC | CAT-PAIS | Valor en catálogo | Por defecto: 170 — Colombia. |
|  | FLD-010 | SCR-001 | S2 Datos del Consumidor Financiero | 7 | Departamento | qd_departamento | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-DPTO | Valor en catálogo | Carga Municipio dinámicamente al seleccionar. |
|  | FLD-011 | SCR-001 | S2 Datos del Consumidor Financiero | 8 | Municipio | qd_municipio | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-MPIO | Pertenece al Departamento seleccionado | Habilitado solo cuando Departamento está seleccionado. Si se cambia dpto., se limpia. |
|  | FLD-012 | SCR-001 | S3 Clasificación y Datos de la Queja | 1 | Asunto / Resumen | qd_motivoSFC | Texto | Texto | Sí | Sí | No | — | Usuario |  | Máx 500 car. Sin caracteres no SFC |  |
|  | FLD-013 | SCR-001 | S3 Clasificación y Datos de la Queja | 2 | Descripción de la Queja | qd_textoQueja | Texto | Área de texto | No | Sí | No | — | Usuario |  | Máx 4000 caracteres |  |
|  | FLD-014 | SCR-001 | S3 Clasificación y Datos de la Queja | 3 | Producto SFC | qd_productoSFC | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-PRODUCTO-SFC | Valor en catálogo SFC | Homologado a catálogo SFC para envío a SmartSupervision. |
|  | FLD-015 | SCR-001 | S3 Clasificación y Datos de la Queja | 4 | Motivo SFC | qd_motivoSFC | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-MOTIVO-SFC | Valor en catálogo SFC | Campo crítico: condiciona campos de fraude en M3. |
|  | FLD-016 | SCR-001 | S3 Clasificación y Datos de la Queja | 5 | Tipo de Solicitud (Zurich) | qd_tipoSolicitudInterno | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo Zurich | CAT-TIPO-SOL | Valor en catálogo | Solo uso interno. No va a SmartSupervision. |
|  | FLD-017 | SCR-001 | S3 Clasificación y Datos de la Queja | 6 | Instancia de Recepción | qd_instanciaRecepcion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-INSTANCIA | Valor en catálogo |  |
|  | FLD-018 | SCR-001 | S3 Clasificación y Datos de la Queja | 7 | Punto de Recepción | qd_puntoRecepcion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-PUNTO | Valor en catálogo |  |
|  | FLD-019 | SCR-001 | S3 Clasificación y Datos de la Queja | 8 | Admisión | qd_admision | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-ADMISION | Valor en catálogo |  |
|  | FLD-020 | SCR-001 | S3 Clasificación y Datos de la Queja | 9 | Ente de Control | qd_enteControl | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-ENTE | Valor en catálogo |  |
|  | FLD-021 | SCR-001 | S4 Adjuntos | 1 | ¿Incluye Anexos a la Queja? | qd_incluyeAnexos | Booleano | Radio Sí/No | Sí | Sí | No | No | Usuario |  | Sí o No | Indicador regulatorio SFC. Obligatorio. |
|  | FLD-022 | SCR-001 | S4 Adjuntos | 2 | Archivos Adjuntos | qd_adjuntosQueja | Archivo | Archivo (multi) | No | Sí | No | — | Usuario |  | PDF/JPG/PNG. Máx 5 archivos, 5 MB c/u |  |
|  | FLD-030 | SCR-002 | S1 Datos del Caso (solo lectura) | 1 | Número de Caso | qd_idCasoBPM | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-031 | SCR-002 | S1 Datos del Caso (solo lectura) | 2 | Canal de Recepción | qd_canal | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-032 | SCR-002 | S1 Datos del Caso (solo lectura) | 3 | SLA Restante (días hábiles) | qd_slaRestante | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | Semaforizado: verde >5d, amarillo 3-5d, rojo <3d, negro = vencido. |
|  | FLD-033 | SCR-002 | S2 Resumen de Errores | 1 | Total de errores pendientes | qd_contadorErrores | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | El botón 'Guardar' se habilita cuando llega a 0. |
|  | FLD-034 | SCR-002 | S2 Resumen de Errores | 2 | Panel de errores detectados | qd_panelErrores | Lista de registros | Tabla/Grid | No | No | Sí | — | Sistema (P01-T06) |  | — | Columnas: Campo | Valor rechazado | Mensaje de error | Formato esperado. |
|  | FLD-035 | SCR-002 | S3 Campos con Error | 1 | Campo(s) con error (dinámico) | qd_camposConError | Dinámico | Texto o Lista según campo | Sí | Sí | No | — | Sistema → Usuario |  | Según tipo de campo | El sistema muestra SOLO los campos que fallaron. Resaltados en rojo con mensaje específico. |
...
|  | FLD-060 | SCR-005 | S1 Encabezado Estado del Caso | 1 | ID Caso BPM | qd_idCasoBPM | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-061 | SCR-005 | S1 Encabezado Estado del Caso | 2 | Código SFC (Radicado) | qd_codigoSFC | Texto | Label/Solo lectura | No | No | Sí | — | SmartSupervision |  | — | Código 1391... Solo lectura. |
|  | FLD-062 | SCR-005 | S1 Encabezado Estado del Caso | 3 | Estado actual del caso | qd_estadoCaso | Texto | Badge/Estado | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-063 | SCR-005 | S1 Encabezado Estado del Caso | 4 | SLA: Días hábiles restantes | qd_slaRestante | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | Semaforizado: verde >5d, amarillo 3-5d, rojo <3d, negro = vencido. |
|  | FLD-064 | SCR-005 | S1 Encabezado Estado del Caso | 5 | Fecha límite de respuesta | qd_fechaLimite | Fecha | Label/Solo lectura | No | No | Sí | — | Sistema (P01-T05) |  | — | Calculada en días hábiles Colombia. |
|  | FLD-065 | SCR-005 | S1 Encabezado Estado del Caso | 6 | Responsable actual | qd_responsableActual | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-066 | SCR-005 | S2 Datos del Consumidor | 1 | Nombre del Consumidor | qd_nombres + qd_apellidos / qd_razonSocial | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-067 | SCR-005 | S2 Datos del Consumidor | 2 | Tipo y N.° de Identificación | qd_tipoIdentificacion + qd_numeroIdentificacion | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-068 | SCR-005 | S2 Datos del Consumidor | 3 | Correo Electrónico | qd_correoElectronico | Correo | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-069 | SCR-005 | S2 Datos del Consumidor | 4 | Tipo de Persona | qd_tipoPersona | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-070 | SCR-005 | S3 Clasificación Regulatoria | 1 | Canal de Recepción | qd_canal | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-071 | SCR-005 | S3 Clasificación Regulatoria | 2 | Producto SFC | qd_productoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-072 | SCR-005 | S3 Clasificación Regulatoria | 3 | Motivo SFC | qd_motivoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-073 | SCR-005 | S3 Clasificación Regulatoria | 4 | Instancia / Punto de Recepción | qd_instanciaRecepcion | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-074 | SCR-005 | S3 Clasificación Regulatoria | 5 | Admisión | qd_admision | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-075 | SCR-005 | S3 Clasificación Regulatoria | 6 | Ente de Control | qd_enteControl | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-076 | SCR-005 | S4 Descripción de la Queja | 1 | Asunto de la Queja | qd_motivoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-077 | SCR-005 | S4 Descripción de la Queja | 2 | Descripción / Texto de la Queja | qd_textoQueja | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-078 | SCR-005 | S4 Descripción de la Queja | 3 | Adjuntos del cliente | qd_adjuntosCliente | Archivo | Lista de adjuntos | No | No | Sí | — | Caso |  | — | Solo visualización y descarga. |
|  | FLD-079 | SCR-005 | S5 Estado SmartSupervision | 1 | Estado SmartSupervision | qd_estadoSS | Texto | Badge/Estado | No | No | Sí | — | Sistema |  | — | Pendiente / Radicado (201) / Rechazado (400) / Cerrado (200). |
|  | FLD-080 | SCR-005 | S5 Estado SmartSupervision | 2 | Intentos M1/M2 | qd_intentosM1M2 | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-081 | SCR-005 | S5 Estado SmartSupervision | 3 | Fecha/Hora radicación SFC | qd_fechaRadicacion | Fecha/Hora | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | Timestamp del HTTP 201 exitoso. |
|  | FLD-082 | SCR-005 | S6 Asignación de Responsable | 1 | Área responsable | qd_areaResponsable | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo Zurich | CAT-AREA | Valor en catálogo | Áreas habilitadas para quejas. |
|  | FLD-083 | SCR-005 | S6 Asignación de Responsable | 2 | Usuario responsable | qd_usuarioResponsable | Catálogo | Lista desplegable filtrada | Sí | Sí | No | — | Sistema (usuarios BPM) | CAT-USUARIOS-ROLE | Filtrado por área y rol autorizado | Solo usuarios autorizados para gestionar quejas. |
|  | FLD-084 | SCR-005 | S6 Asignación de Responsable | 3 | Observaciones de asignación | qd_observacionesAsignacion | Texto | Área de texto | No | Sí | No | — | Usuario |  | — |  |
|  | FLD-090 | SCR-006 | S1 Datos de Reasignación | 1 | Responsable actual | qd_responsableActual | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-091 | SCR-006 | S1 Datos de Reasignación | 2 | Área destino | qd_areaDestino | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo Zurich | CAT-AREA | Valor en catálogo |  |
|  | FLD-092 | SCR-006 | S1 Datos de Reasignación | 3 | Nuevo responsable | qd_nuevoResponsable | Catálogo | Lista desplegable filtrada | Sí | Sí | No | — | Sistema (BPM) | CAT-USUARIOS-ROLE | Solo usuarios autorizados | Filtrado por área y rol. Prohibida asignación a usuarios fuera del proceso. |
|  | FLD-093 | SCR-006 | S1 Datos de Reasignación | 4 | Motivo de reasignación | qd_motivoReasignacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo Zurich | CAT-MOTIVO-REASIG | Valor en catálogo |  |
|  | FLD-094 | SCR-006 | S1 Datos de Reasignación | 5 | Observaciones (justificación) | qd_observacionesReasignacion | Texto | Área de texto | Sí | Sí | No | — | Usuario |  | Campo no vacío | Obligatorio. Queda en historial para auditoría. |
|  | FLD-095 | SCR-006 | S2 Historial de Asignaciones | 1 | Historial de asignaciones previas | qd_historialAsignaciones | Lista de registros | Tabla/Grid | No | No | Sí | — | Sistema |  | — | Columnas: Fecha | De | Para | Motivo. Solo lectura. |
|  | FLD-100 | SCR-007 | S1 Datos del Caso (solo lectura) | 1 | ID Caso / Código SFC | qd_codigoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-101 | SCR-007 | S1 Datos del Caso (solo lectura) | 2 | SLA: Días hábiles restantes | qd_slaRestante | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | Semaforizado. |
|  | FLD-102 | SCR-007 | S1 Datos del Caso (solo lectura) | 3 | Estado del caso | qd_estadoCaso | Texto | Badge/Estado | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-103 | SCR-007 | S1 Datos del Caso (solo lectura) | 4 | Producto SFC / Motivo SFC | qd_productoMotivo | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-104 | SCR-007 | S1 Datos del Caso (solo lectura) | 5 | Nombre del Consumidor | qd_nombres + qd_apellidos / qd_razonSocial | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-105 | SCR-007 | S1 Datos del Caso (solo lectura) | 6 | Texto de la queja | qd_textoQueja | Texto | Label/Solo lectura | No | No | Sí | — | Caso |  | — |  |
|  | FLD-106 | SCR-007 | S2 Observaciones SAC (visible si es ajuste) | 1 | Observaciones del Analista SAC | qd_observacionesSAC | Texto | Label/Solo lectura | No | No | Sí | — | SAC (SP2-T04) |  | — | Visible solo cuando fue devuelto por SAC. |
|  | FLD-107 | SCR-007 | S2 Observaciones SAC (visible si es ajuste) | 2 | Versión de revisión actual | qd_versionRevision | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — | Revisión 1, 2... |
|  | FLD-108 | SCR-007 | S3 Elaboración de Respuesta Técnica | 1 | Causa Raíz Identificada | qd_causaRaiz | Texto | Área de texto | Sí | Sí | No | — | Usuario |  | Campo no vacío |  |
|  | FLD-109 | SCR-007 | S3 Elaboración de Respuesta Técnica | 2 | Posición de Zurich | qd_posicionZurich | Texto | Área de texto | Sí | Sí | No | — | Usuario |  | Campo no vacío |  |
|  | FLD-110 | SCR-007 | S3 Elaboración de Respuesta Técnica | 3 | Respuesta al Cliente (borrador) | qd_respuestaCliente | Texto | Área de texto | Sí | Sí | No | — | Usuario |  | Campo no vacío | Este texto irá en la carta PDF de respuesta final. |
|  | FLD-111 | SCR-007 | S3 Elaboración de Respuesta Técnica | 4 | Acciones Tomadas | qd_accionesTomadas | Texto | Área de texto | No | Sí | No | — | Usuario |  | — |  |
|  | FLD-112 | SCR-007 | S3 Elaboración de Respuesta Técnica | 5 | ¿Reconocimiento al cliente? | qd_reconocimiento | Booleano | Radio Sí/No | Sí | Sí | No | — | Usuario |  | — |  |
|  | FLD-113 | SCR-007 | S4 Soportes Internos | 1 | Adjuntos internos de soporte | qd_adjuntosSoporte | Archivo | Archivo (multi) | No | Sí | No | — | Usuario |  | Máx 10 archivos | No van al cliente ni a SFC. Solo uso interno. |
...
|  | FLD-127 | SCR-008 | S2 Respuesta del Área (solo lectura) | 3 | Respuesta al Cliente | qd_respuestaCliente | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-07) |  | — |  |
|  | FLD-128 | SCR-008 | S2 Respuesta del Área (solo lectura) | 4 | Acciones Tomadas | qd_accionesTomadas | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-07) |  | — |  |
|  | FLD-129 | SCR-008 | S2 Respuesta del Área (solo lectura) | 5 | ¿Reconocimiento al cliente? | qd_reconocimiento | Texto | Label/Solo lectura | No | No | Sí | — | Área (PAN-07) |  | — |  |
|  | FLD-130 | SCR-008 | S2 Respuesta del Área (solo lectura) | 6 | Soportes internos adjuntos | qd_adjuntosSoporte | Archivo | Lista de adjuntos | No | No | Sí | — | Área (PAN-07) |  | — | Solo visualización. |
...
|  | FLD-140 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 1 | Código SFC | qd_codigoSFC | Texto | Label/Solo lectura | No | No | Sí | — | SmartSupervision |  | — |  |
|  | FLD-141 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 2 | Canal (precargado M1) | qd_canal | Texto | Label/Solo lectura | No | No | Sí | — | Caso M1 |  | — | No editable. Precargado desde Momento 1. |
|  | FLD-142 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 3 | Producto (precargado M1) | qd_productoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Caso M1 |  | — | No editable. |
|  | FLD-143 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 4 | Motivo (precargado M1) | qd_motivoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Caso M1 |  | — | No editable. |
|  | FLD-144 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 5 | Admisión (precargado M1) | qd_admision | Texto | Label/Solo lectura | No | No | Sí | — | Caso M1 |  | — | No editable. |
|  | FLD-145 | SCR-009 | S1 Datos Precargados M1 (solo lectura) | 6 | Ente de Control (precargado M1) | qd_enteControl | Texto | Label/Solo lectura | No | No | Sí | — | Caso M1 |  | — | No editable. |
|  | FLD-146 | SCR-009 | S2 Datos del Consumidor — Campos SFC | 1 | Sexo | qd_sexo | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-SEXO | Valor en catálogo |  |
|  | FLD-147 | SCR-009 | S2 Datos del Consumidor — Campos SFC | 2 | LGBTIQ+ | qd_lgbtiq | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-LGBTIQ | Valor en catálogo | ⚠ Catálogo pendiente confirmación con TI (CE 019/2024). |
|  | FLD-148 | SCR-009 | S2 Datos del Consumidor — Campos SFC | 3 | Condición Especial | qd_condicionEspecial | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-COND-ESP | Valor en catálogo |  |
|  | FLD-149 | SCR-009 | S2 Datos del Consumidor — Campos SFC | 4 | Producto Digital | qd_productoDigital | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-PROD-DIGITAL | Valor en catálogo |  |
|  | FLD-150 | SCR-009 | S3 Condición de la Queja | 1 | Estado de la Queja o Reclamo | qd_estadoQueja | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-ESTADO-QUEJA | Valor en catálogo |  |
|  | FLD-151 | SCR-009 | S3 Condición de la Queja | 2 | Favorabilidad | qd_favorabilidad | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-FAVORAB | Valor en catálogo | A favor cliente / A favor entidad / Parcial. |
|  | FLD-152 | SCR-009 | S3 Condición de la Queja | 3 | Aceptación | qd_aceptacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-ACEPTACION | Valor en catálogo |  |
|  | FLD-153 | SCR-009 | S3 Condición de la Queja | 4 | Rectificación | qd_rectificacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-RECTIF | Valor en catálogo |  |
|  | FLD-154 | SCR-009 | S3 Condición de la Queja | 5 | Desistimiento | qd_desistimiento | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-DESIST | Valor en catálogo |  |
|  | FLD-155 | SCR-009 | S3 Condición de la Queja | 6 | Tutela | qd_tutela | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-TUTELA | Valor en catálogo |  |
|  | FLD-156 | SCR-009 | S3 Condición de la Queja | 7 | Marcación | qd_marcacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-MARCACION | Valor en catálogo |  |
|  | FLD-157 | SCR-009 | S3 Condición de la Queja | 8 | Queja Exprés | qd_quejaExpres | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-EXPRES | Valor en catálogo |  |
|  | FLD-158 | SCR-009 | S4 Datos de Fraude CE-019-2024 (condicional) | 1 | ¿Relacionada con Fraude? | qd_relacionadaFraude | Booleano | Radio Sí/No | Sí | Sí | No | No | Usuario |  | — | Si Sí, habilita campos FLD-159 a FLD-162. |
|  | FLD-159 | SCR-009 | S4 Datos de Fraude CE-019-2024 (condicional) | 2 | Tipo de Fraude | qd_tipoFraude | Catálogo | Lista desplegable | Cond. | Sí | No | — | Catálogo SFC | CAT-TIPO-FRAUDE | Obligatorio si relacionadaFraude=Sí | CE 019/2024. Desde 1 jul 2025. |
|  | FLD-160 | SCR-009 | S4 Datos de Fraude CE-019-2024 (condicional) | 3 | Modalidad de Fraude | qd_modalidadFraude | Catálogo | Lista desplegable | Cond. | Sí | No | — | Catálogo SFC | CAT-MOD-FRAUDE | Obligatorio si relacionadaFraude=Sí | CE 019/2024. |
|  | FLD-161 | SCR-009 | S4 Datos de Fraude CE-019-2024 (condicional) | 4 | Monto Reclamado (COP) | qd_montoReclamado | Moneda | Número | Cond. | Sí | No | — | Usuario |  | Obligatorio si relacionadaFraude=Sí | CE 019/2024. |
|  | FLD-162 | SCR-009 | S4 Datos de Fraude CE-019-2024 (condicional) | 5 | Monto Reconocido (COP) | qd_montoReconocido | Moneda | Número | Cond. | Sí | No | — | Usuario |  | Obligatorio si relacionadaFraude=Sí | CE 019/2024. |
...
|  | FLD-166 | SCR-009 | S5 Anexos del Formulario | 4 | Prórroga (días, si aplica) | qd_diasProrroga | Número | Número | No | Sí | No | 0 | Usuario |  | — | Solo cuando viene de SP4. |
|  | FLD-170 | SCR-010 | S1 Estado del Cierre SmartSupervision | 1 | Estado del cierre M3 | qd_estadoCierreM3 | Texto | Badge/Estado | No | No | Sí | — | Sistema |  | — | Pendiente / Enviando / Rechazado (400) / Aceptado (200). |
|  | FLD-171 | SCR-010 | S1 Estado del Cierre SmartSupervision | 2 | Intentos cierre M3 | qd_intentosCierreM3 | Número | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-172 | SCR-010 | S1 Estado del Cierre SmartSupervision | 3 | Último error (si aplica) | qd_ultimoError | Texto | Panel de error | No | No | Sí | — | API SmartSupervision |  | — | Mensaje y campo del último rechazo. |
|  | FLD-173 | SCR-010 | S2 Datos del Cierre | 1 | Código SFC | qd_codigoSFC | Texto | Label/Solo lectura | No | No | Sí | — | Sistema |  | — |  |
|  | FLD-174 | SCR-010 | S2 Datos del Cierre | 2 | Estado de la Queja | qd_estadoQueja | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-ESTADO-QUEJA | Valor en catálogo |  |
|  | FLD-175 | SCR-010 | S2 Datos del Cierre | 3 | Fecha de Actualización | qd_fechaActualizacion | Fecha | Calendario | Sí | Sí | No | — | Usuario |  | ⚠ DEBE = fechaCierre (validación en tiempo real) | RUL-10-01 CRÍTICO: bloquea botón si no coincide con fechaCierre. |
|  | FLD-176 | SCR-010 | S2 Datos del Cierre | 4 | Fecha de Cierre | qd_fechaCierre | Fecha | Calendario | Sí | Sí | No | — | Usuario |  | ⚠ DEBE = fechaActualizacion (validación en tiempo real) | RUL-10-01 CRÍTICO. |
|  | FLD-177 | SCR-010 | S2 Datos del Cierre | 5 | Favorabilidad | qd_favorabilidad | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC / PAN-09 | CAT-FAVORAB | Valor en catálogo | Precargado de PAN-09. Editable si hubo error. |
|  | FLD-178 | SCR-010 | S2 Datos del Cierre | 6 | Aceptación | qd_aceptacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC / PAN-09 | CAT-ACEPTACION | Valor en catálogo | Precargado de PAN-09. |
|  | FLD-179 | SCR-010 | S2 Datos del Cierre | 7 | Marcación | qd_marcacion | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC / PAN-09 | CAT-MARCACION | Valor en catálogo |  |
|  | FLD-180 | SCR-010 | S2 Datos del Cierre | 8 | Queja Exprés | qd_quejaExpres | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC / PAN-09 | CAT-EXPRES | Valor en catálogo |  |
|  | FLD-181 | SCR-010 | S3 PDF de Respuesta Final | 1 | PDF Respuesta Final | qd_pdfRespuestaFinal | Archivo | Archivo + Validación automática | Sí | Sí | No | — | Sistema (SP2-T06) / Usuario |  | ⚠ Nomenclatura: NombreCliente_NumId_RESP_FINAL_SFC_N. Solo PDF. | RUL-10-02: sistema valida nombre y tipo. Bloquea si no cumple. |
|  | FLD-182 | SCR-010 | S3 PDF de Respuesta Final | 2 | Resultado validación nomenclatura | qd_validacionNomenclatura | Texto | Label estado validación | No | No | Sí | — | Sistema |  | — | ✓ Nomenclatura correcta / ✗ Error específico. |
|  | FLD-183 | SCR-010 | S3 PDF de Respuesta Final | 3 | ¿Adjunto a la respuesta final? | qd_adjuntoRespuestaFinal | Booleano | Radio Sí/No | Sí | Sí | No | Sí | Usuario |  | — |  |
|  | FLD-184 | SCR-010 | S4 Campos Fraude CE-019-2024 (solo lectura) | 1 | ¿Relacionada con fraude? | qd_relacionadaFraude | Texto | Label/Solo lectura | No | No | Sí | — | PAN-09 |  | — | Precargado. |
|  | FLD-185 | SCR-010 | S4 Campos Fraude CE-019-2024 (solo lectura) | 2 | Tipo de Fraude (si aplica) | qd_tipoFraude | Texto | Label/Solo lectura | No | No | Sí | — | PAN-09 |  | — |  |
|  | FLD-186 | SCR-010 | S4 Campos Fraude CE-019-2024 (solo lectura) | 3 | Monto Reclamado (si aplica) | qd_montoReclamado | Moneda | Label/Solo lectura | No | No | Sí | — | PAN-09 |  | — |  |
|  | FLD-187 | SCR-010 | S4 Campos Fraude CE-019-2024 (solo lectura) | 4 | Monto Reconocido (si aplica) | qd_montoReconocido | Moneda | Label/Solo lectura | No | No | Sí | — | PAN-09 |  | — |  |
...
|  | FLD-300 | SCR-000 | S1 Tipo de Solicitud y Rol | 1 | Número de Caso (ID BPM) | qd_idCasoBPM | Texto | Label/Solo lectura | No | No | Sí | [Auto] | Sistema BPM |  | — | Se asigna automáticamente por el sistema al radicar. |
|  | FLD-301 | SCR-000 | S1 Tipo de Solicitud y Rol | 2 | Fecha y Hora de Creación | qd_fechaCreacion | Fecha/Hora | Label/Solo lectura | No | No | Sí | [Auto] | Sistema BPM |  | — | Timestamp automático del sistema. |
...
|  | FLD-304 | SCR-000 | S1 Tipo de Solicitud y Rol | 5 | Punto de Recepción | qd_puntoRecepcion | Catálogo | Label/Solo lectura | Sí | No | Sí | — | Catálogo SFC | CAT-PUNTO | Valor en catálogo (Lista #1) | Campo back. Se asigna automáticamente según el canal/rol. Obligatorio SFC. |
...
|  | FLD-319 | SCR-000 | S2 Datos del Consumidor Financiero | 14 | Dirección | qd_direccion | Alfanumérico | Label/Solo lectura | Sí | No | Sí | vacío | Sistema |  | Enviar por default "vacío" | Back. Pendiente confirmar con API SFC. |
|  | FLD-320 | SCR-000 | S2 Datos del Consumidor Financiero | 15 | Sexo | qd_sexo | Catálogo | Label/Solo lectura | Sí | No | Sí | No aplica | Catálogo SFC | CAT-SEXO | Enviar por default "No aplica" | Back. Pendiente confirmar con API SFC. |
|  | FLD-321 | SCR-000 | S2 Datos del Consumidor Financiero | 16 | LGBTIQ+ | qd_lgbtiq | Catálogo | Label/Solo lectura | Sí | No | Sí | No aplica | Catálogo SFC | CAT-LGBTIQ | Enviar por default "No aplica" | ⚠ Back. Catálogo pendiente confirmar con TI antes de implementar. |
|  | FLD-322 | SCR-000 | S2 Datos del Consumidor Financiero | 17 | Condición especial | qd_condicionEspecial | Catálogo | Label/Solo lectura | Sí | No | Sí | — | Catálogo SFC | CAT-COND-ESP | Valor en catálogo | Back. Solo lectura. Pendiente confirmar lista con TI/SFC. |
...
|  | FLD-328 | SCR-000 | S3 Detalle de la Queja | 6 | Cuéntanos el motivo | qd_motivoSFC | Catálogo | Lista desplegable | Sí | Sí | No | — | Catálogo SFC | CAT-MOTIVO-SFC | Valor en catálogo (Motivos SFC) | Campo crítico: condiciona campos de fraude en M3. |
...
|  | FLD-331 | SCR-000 | S3 Detalle de la Queja | 9 | Admisión | qd_admision | Catálogo | Label/Solo lectura | Sí | No | Sí | No aplica | Catálogo SFC | CAT-ADMISION | Valor en catálogo (Lista #4) | Back. Si el rol = Defensor del Consumidor es editable; si no, default "No aplica". |
...
|  | RUL-001-02 | SCR-001 | FLD-006 | Restricción | Al guardar | qd_numeroIdentificacion contiene letras o longitud <6 o >15 | Bloquear. Mostrar MSG-001-02 | Error | Sí | MSG-001-02 | Bloquea compuerta ¿Datos válidos? |
...
|  | RUL-001-04 | SCR-001 | FLD-012/004 | Restricción | Al guardar | qd_nombres, qd_apellidos o qd_razonSocial contienen caracteres no permitidos SFC | Bloquear. Mostrar MSG-001-03 | Error | Sí | MSG-001-03 | Bloquea compuerta ¿Datos válidos? |
...
|  | RUL-000-06 | Restricción | qd_textoQueja < 50 o > 2000 caracteres |  | Bloquear. Mostrar MSG-000-03 |  | 🔴 BLOQUEA | MSG-000-03 |
...
|  | RUL-000-13 | Restricción | qd_numeroIdentificacion no cumple formato por tipo doc |  | Bloquear. Mostrar MSG-000-07 |  | 🔴 BLOQUEA | MSG-000-07 |
## Sheet: SCR-001
...
|  | RUL-001-02 | Restricción | qd_numeroIdentificacion contiene letras o longitud <6 o >15 |  | Bloquear. Mostrar MSG-001-02 |  | 🔴 BLOQUEA | MSG-001-02 |
|  | RUL-001-03 | Control | departamento está vacío o cambia |  | Deshabilitar y limpiar campo municipio |  | info | — |
|  | RUL-001-04 | Restricción | qd_nombres, qd_apellidos o qd_razonSocial contienen caracteres no permitidos SFC |  | Bloquear. Mostrar MSG-001-03 |  | 🔴 BLOQUEA | MSG-001-03 |
