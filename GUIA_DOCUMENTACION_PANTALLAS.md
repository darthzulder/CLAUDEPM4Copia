...
Antes de leer cualquier archivo de insumos (`.xlsx`, `.pdf`, u otro), **verificar si existe en la misma carpeta `insumos/` un archivo `.md` con el mismo nombre base** (p. ej. `Anexo02_Mockups_TOBE_QuejaDirectas_v3_2.md` junto a su `.xlsx` homónimo). Si existe ese `.md`:
